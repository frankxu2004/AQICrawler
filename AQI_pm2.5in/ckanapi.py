...
def request(resource_dict,action_name,api_key):
	url = 'http://202.121.178.242/api/3/action/' + action_name
	print url
	print resource_dict
...
def datastore_create(resource_id,api_key):
	...
	resource_dict = {
    	...
    	"force": True,
    	"fields": [{"id": "city", "type": "text"}, {"id": "station", "type": "text"},{"id": "longitude", "type": "float"},{"id": "latitude", "type": "float"},{"id": "datetime", "type": "timestamp"}, {"id": "PM2_5", "type": "float"}, {"id": "CO", "type": "float"}, {"id": "PM10", "type": "float"}, {"id": "SO2", "type": "float"}, {"id": "O3", "type": "float"}, {"id": "NO2", "type": "float"}],
    	# 'resource': resource,
